...
export default function PDashboardMain() {
  return (
    <div className="flex-1 bg-neutral-secondary w-full flex h-full justify-center items-center">
      ...
      <DashboardCard propClassName="">
        <DbCardHeader propClassName="text-3xl text-brand-dark gap-y-2">
          <SalesIcon width={"w-10"} height={"h-10"} />
          Customers & Sales
        </DbCardHeader>
        {/* <DbCardBody
                    orderReverse={false}
          ...
          content={[
            {
              ...
              label: "Customers",
              labelClassName: "text-start text-blue-400",
              containingDivClassName: "",
            },
            {
              value: "1,240",
              valueClassName: "text-start",
        ...
        />
        <DbCardFooter>View Report</DbCardFooter>
      </DashboardCard>
    </div>
  );
}

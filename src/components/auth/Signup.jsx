...
// // /* ── Egyptian regions — replace IDs with your backend's actual values ── */
// // const EGYPT_REGIONS = [
// //   { id: 1, name: "Cairo" },
// //   { id: 2, name: "Giza" },
...
// // /* ════════════════════════════════════════════════════════
// //    RoleForm — key=activeRole forces remount on role switch
// // ════════════════════════════════════════════════════════ */
...
// //       // regionId is already a number after schema transform; keep as-is
// //       // Remove optional URL fields if they are empty strings
// //       if (!payload.documentImageUrl) delete payload.documentImageUrl;
// //       if (!payload.licenseImageUrl) delete payload.licenseImageUrl;

// //       console.log("📤 Sending to", ENDPOINT_MAP[activeRole], payload);
// //       const res = await api.post(ENDPOINT_MAP[activeRole], payload);
// //       console.log("✅ Response:", res.data);

// //       onSuccess(res.data?.message || "Your application is under review.");
...
// //     toast.success("Registration submitted! 🎉", msg);
// //   }
...
// //                   {/* key forces full remount on role switch → fresh resolver */}
// //                   <RoleForm
// //                     key={activeRole}

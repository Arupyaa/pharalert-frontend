    ...
    <div className="min-h-screen p-6" style={{ background: "var(--bg-secondary)" }}>
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm" style={{ color: "var(--text-muted)" }}>
          Upgrade your account to unlock reservation features
        </p>
      </div>
      ...
      {!isPaid && (
        ...
        >
          <h2 className="text-lg font-bold mb-1" style={{ color: "var(--text-heading)" }}>
            Premium Plan — EGP {PLAN_PRICE}/month
          </h2>
          <p className="text-sm mb-4" style={{ color: "var(--text-muted)" }}>
            Unlock the ability to create medicine reservations at nearby pharmacies.
          </p>
          <ul className="space-y-2 mb-5 text-sm" style={{ color: "var(--text-muted)" }}>
            {["Create medicine reservations", "Priority pharmacy search", "Order tracking & history", "Save favorite medications"].map((f) => (

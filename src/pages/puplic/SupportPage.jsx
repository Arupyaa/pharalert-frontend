        ...
        <div className="grid sm:grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-white/70 text-sm mb-5">
              Talk to a support agent instantly — available 24 hours a day.
            </p>
            <button className="bg-white text-[var(--brand-primary)] px-6 py-3 rounded-xl font-semibold text-sm hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200">
              Start Chat
            </button>
          </div>
          <div className="p-8 rounded-3xl border border-gray-100 bg-white">
            ...
            <NavLink
              to="/help/contact-us"
              className="inline-flex items-center gap-2 bg-[var(--brand-primary)] text-white px-6 py-3 rounded-xl font-semibold text-sm hover:shadow-[0_6px_20px_rgba(0,171,121,0.35)] hover:-translate-y-0.5 transition-all duration-200"
            >
              Send Email
            </NavLink>
          </div>

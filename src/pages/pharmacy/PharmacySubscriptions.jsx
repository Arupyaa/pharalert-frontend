...
export default function PharmacySubscriptions() {
    ...
    <div className="min-h-screen p-6" style={{ background: "var(--bg-secondary)" }}>
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm" style={{ color: "var(--text-muted)" }}>
          Manage your pharmacy plan and billing
        </p>
      </div>
      ...
      {!isActive && (
        ...
        >
          <h2 className="text-lg font-bold mb-1" style={{ color: "var(--text-heading)" }}>
            Pharmacy Plan — EGP {PLAN_PRICE}/month
          </h2>
          <p className="text-sm mb-4" style={{ color: "var(--text-muted)" }}>
            Get full access to inventory, sales, cashier, and all pharmacy features.
          </p>
          <ul className="space-y-2 mb-5 text-sm" style={{ color: "var(--text-muted)" }}>
            {["Manage inventory & stock alerts", "POS cashier system", "Sales & receipt tracking", "Real-time medicine search"].map((f) => (
